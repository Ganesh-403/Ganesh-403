<!-- Top Banner -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=F74C00&height=200&section=header&text=Ganesh%20Kambli&fontSize=50&fontColor=ffffff&fontAlignY=38&desc=Software%20Developer%20%7C%20Python%20%7C%20Full-Stack%20%7C%20ML&descAlignY=58&descSize=16&animation=fadeIn"/>
</p>
...
<table>
  <tr>
    ...
    <td>
      ...
      <br/>JM Road, Pune
      <br/><br/>
      ▸ Built an end-to-end <strong>Absence Detection System</strong> (Python + Google Sheets API + GitHub Actions) — cut reporting time by <strong>~80%</strong>, reduced human error to zero<br/>
      ▸ Redesigned <strong>3 Python course modules</strong> and authored <strong>10+ interactive quizzes</strong> on MOODLE LMS<br/>
      ▸ Built a <strong>real-time Google Sheets monitoring pipeline</strong> automating data reconciliation across multiple workflows
    </td>
  </tr>
</table>
